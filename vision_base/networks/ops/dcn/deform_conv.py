...
if (torch.version.cuda < '10.0'):
    import warnings
    warnings.warn("Cuda version lower than 10.0 may not support the compilation of Deformable Conv, but the other part of the package will be fine", RuntimeWarning)
